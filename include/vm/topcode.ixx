...
export namespace Tona {
  ...
  const std::flat_map<std::string_view, OpCode> opcodes {
    ...
    {"dbg.printg",    OpCode::OC_DEBUG_PRINT_G},
    {"dbg.prints",    OpCode::OC_DEBUG_PRINT_S},
    {"dbg.regs",      OpCode::OC_DEBUG_PRINT_REGS},
    {"dbg.dumpstk",   OpCode::OC_DEBUG_PRINT_DUMPSTK},
    {"dbg.dumpmem",   OpCode::OC_DEBUG_PRINT_DUMPMEM},
    ...
    {"alu.f32neg",   OpCode::OC_ALU_NEG_F32},
    {"alu.f64neg",   OpCode::OC_ALU_NEG_F64},
    ...
    {"ctl.jmp",     OpCode::OC_CTRL_JMP},
    {"ctl.jmpo",    OpCode::OC_CTRL_JMPO},
    {"ctl.jz",      OpCode::OC_CTRL_JZ},
    {"ctl.jnz",     OpCode::OC_CTRL_JNZ},
    {"ctl.je",      OpCode::OC_CTRL_JE},
    {"ctl.jne",     OpCode::OC_CTRL_JNE},
    {"ctl.jl",      OpCode::OC_CTRL_JL},
    {"ctl.jle",     OpCode::OC_CTRL_JLE},
    {"ctl.jb",      OpCode::OC_CTRL_JB},
    {"ctl.jbe",     OpCode::OC_CTRL_JBE},
    {"ctl.f32je",   OpCode::OC_CTRL_F32JE},
    {"ctl.f32jne",  OpCode::OC_CTRL_F32JNE},
    {"ctl.f32jl",   OpCode::OC_CTRL_F32JL},
    {"ctl.f32jle", OpCode::OC_CTRL_F32JLE},
    {"ctl.f64je",  OpCode::OC_CTRL_F64JE},
    {"ctl.f64jne", OpCode::OC_CTRL_F64JNE},
    {"ctl.f64jl",  OpCode::OC_CTRL_F64JL},
    {"ctl.f64jle", OpCode::OC_CTRL_F64JLE},
    {"ctl.ijne",   OpCode::OC_CTRL_INC_JNE},
    {"ctl.djnz",   OpCode::OC_CTRL_DEC_JNZ},
    {"ctl.call",   OpCode::OC_CTRL_CALL},
    {"ctl.ret",    OpCode::OC_CTRL_RET}
  };
